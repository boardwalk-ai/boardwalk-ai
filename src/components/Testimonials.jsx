        ...
        {rows.map((t, i) => (
          <div key={i} data-hover style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28 }}>
              ...
              <div style={{
                fontFamily: F.mono, fontSize: 10, color: C.mute, letterSpacing: '0.2em',
                border: `1px solid ${C.line}`, padding: '4px 10px',
              }}>
                {t.tag}
              </div>
            </div>
            <div style={{
              ...
              lineHeight: 1.35, flex: 1, letterSpacing: '-0.005em', color: C.ink,
            }}>
              "{t.q}"
            </div>
