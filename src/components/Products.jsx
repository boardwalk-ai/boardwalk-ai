...
function ScrollWord() {
  ...
  useEffect(() => {
    const on = () => {
      ...
      const prog = 1 - r.top / window.innerHeight;
      setX(prog * -200);
    };
    on();
  ...
  return (
    <section style={{ background: C.bg, padding: '160px 48px 140px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, marginBottom: 64, position: 'relative' }}>
        ...
        <div style={{ fontFamily: F.mono, fontSize: 11, color: C.mute, letterSpacing: '0.2em', textAlign: 'right' }}>
          01 / 01 SHIPPING
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          paddingBottom: 56, display: 'flex', flexDirection: 'column',
        ...
        <div style={{ position: 'relative', alignSelf: 'end' }}>
          <div style={{
            ...
            <img
              src="/octopilot-preview.png"
              alt="Octopilot AI interface"
